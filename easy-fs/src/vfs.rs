...
impl Inode {
    ...
    /// Create a vfs inode from a disk inode
    ...
    pub fn create_link(&self, name: &str, link: u32) -> Option<Arc<Inode>> {
        self.create_inode(name, link, DiskInodeType::File, true)
    }
    ...
    pub fn create(&self, name: &str) -> Option<Arc<Inode>> {
        ...
        self.create_inode(name, new_inode_id, DiskInodeType::File, false)
    }
