...
use crate::{
    ...
    task::{
        add_task, current_task, current_user_token, exit_current_and_run_next, get_syscall_times, get_time_first_called, suspend_current_and_run_next, TaskStatus
    },
...
pub fn sys_task_info(ti: *mut TaskInfo) -> isize {
    ...
    let buffer = translated_byte_buffer(current_user_token(), ti as *const u8, core::mem::size_of::<TaskInfo>());
...
pub fn sys_mmap(start: usize, len: usize, port: usize) -> isize {
    ...
    for i in 0..page_count {
        ...
        match inner.memory_set.translate(vpa.into()) {
            Some(pte) => {
                if pte.is_valid() {
                    return -1;
                }
...
pub fn sys_munmap(start: usize, len: usize) -> isize {
    ...
    inner.memory_set.pop(VirtAddr::from(start).into());
    0
}
